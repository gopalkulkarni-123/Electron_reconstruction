...
#for loop starts
    for i, batch in enumerate(iterator):
        ...
        output_prior, output_decoder, mixture_weights_logits = model(g_clouds, p_clouds, images=None, n_sampled_points=None, labeled_samples=False, warmup=False)
